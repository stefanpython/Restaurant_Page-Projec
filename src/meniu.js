export function mainMeniu() {
    ...
    <img class="menuImg" src="images/burger2.jpg" alt="cat">
    ...
    <img class="menuImg" src="images/vegan.jpg" alt="cat">
    ...
    <img class="menuImg" src="images/burger3.jpg" alt="cat">
    ...
    <img class="menuImg" src="images/drink3.jpg" alt="">
